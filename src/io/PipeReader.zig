...
pub fn PosixPipeReader(
    ...
    comptime vtable: struct {
        ...
        getLimit: *const fn (*This) ?*u64,
    },
) type {
    return struct {
        pub fn read(this: *This, limit: ?*u64) void {
        ...
        fn readFile(parent: *This, resizable_buffer: *std.ArrayList(u8), fd: bun.FileDescriptor, size_hint: isize, received_hup: bool, limit: ?*u64) void {
        ...
        fn readSocket(parent: *This, resizable_buffer: *std.ArrayList(u8), fd: bun.FileDescriptor, size_hint: isize, received_hup: bool, limit: ?*u64) void {
            return readWithFn(parent, resizable_buffer, fd, size_hint, received_hup, .socket, wrapReadFn(bun.sys.recvNonBlock), limit);
        }

        fn readPipe(parent: *This, resizable_buffer: *std.ArrayList(u8), fd: bun.FileDescriptor, size_hint: isize, received_hup: bool, limit: ?*u64) void {
        ...
        fn readBlockingPipe(parent: *This, resizable_buffer: *std.ArrayList(u8), fd: bun.FileDescriptor, size_hint: isize, received_hup: bool, limit: ?*u64) void {
            return readWithFn(parent, resizable_buffer, fd, size_hint, received_hup, .pipe, wrapReadFn(bun.sys.readNonblocking), limit);
        }

        fn readWithFn(parent: *This, resizable_buffer: *std.ArrayList(u8), fd: bun.FileDescriptor, size_hint: isize, received_hup_: bool, comptime file_type: FileType, comptime sys_fn: *const fn (bun.FileDescriptor, []u8, usize) JSC.Maybe(usize), limit: ?*u64) void {
            _ = size_hint; // autofix
            ...
            while (true) {
                ...
                switch (sys_fn(fd, buffer, parent._offset)) {
                    .result => |bytes_read| {
                        // maxbuf
                        if (limit != null and resizable_buffer.items.len + bytes_read > limit.?.*) {
                            resizable_buffer.items.len = @min(resizable_buffer.items.len + bytes_read, limit.?.*);
                            vtable.close(parent);
        ...
        fn readFromBlockingPipeWithoutBlocking(parent: *This, resizable_buffer: *std.ArrayList(u8), fd: bun.FileDescriptor, size_hint: isize, received_hup: bool, limit: ?*u64) void {
            if (parent.vtable.isStreamingEnabled()) {
                resizable_buffer.clearRetainingCapacity();
            }
...
const BufferedReaderVTable = struct {
    ...
    pub const Fn = struct {
        ...
        getLimit: *const fn (*anyopaque) ?*u64,
...
const PosixBufferedReader = struct {
    ...
    pub fn getLimit(this: *PosixBufferedReader) ?*u64 {
